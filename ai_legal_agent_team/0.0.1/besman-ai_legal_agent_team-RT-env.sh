...
function __besman_install() {
    ...
    __besman_echo_white "🚀 Installing environment for ai_legal_agent_team POI..."
    ...
    POI_PATH="$BESMAN_ARTIFACT_DIR/advanced_ai_agents/multi_agent_apps/agent_teams/ai_legal_agent_team"
    ...
    __besman_echo_white "✅ Installation complete for ai_legal_agent_team POI."
}

function __besman_uninstall() {

    __besman_echo_white "🧹 Starting environment cleanup for ai_legal_agent_team POI..."
    ...
    __besman_echo_white "✅ Uninstallation complete for ai_legal_agent_team POI."
}

function __besman_validate() {

    __besman_echo_white "🔎 Validating environment for ai_legal_agent_team POI..."
...
function __besman_update() {
    ...
    __besman_echo_white "🔄 Updating environment for ai_legal_agent_team POI..."
    ...
    __besman_echo_white "✅ Update process completed for ai_legal_agent_team POI."
}

function __besman_reset() {

    __besman_echo_white "♻️ Resetting environment for ai_legal_agent_team POI..."
    ...
    __besman_echo_white "✅ Reset process completed for ai_legal_agent_team POI."
}
