# Contributing to BeSman Environment Repo

Thank you for contributing your time and expertise to the BeSman Environment Repo. This document provides guidance on environments contribution recommended practices. It covers what we're looking for in order to help set expectations and help you get the most out of participation in this project.

This repo contains scripts which BeSman uses to set-up environments for projects/ml models...The repo is maintained by Be-Secure Community and the owners of BeSman.
Eventhough this is a separate repo, it has a close coupling with BeSman. All the bugs and enhancements for the environment repo will be maintained in the [issue](https://github.com/Be-Secure/BeSman/issues) section of BeSman.
...
If you are a new contributor to BeSman Environment Repo, or looking to get started committing to the Be-Secure ecosystem, here are a couple of tips to get started.
...
- [BeSman]([./README.md](https://github.com/Be-Secure/BeSman)).
- [BeSman environment repo](./README.md).
...
1. Contributor License Agreement (CLA): If this is your first contribution to Be-Secure environment repo, you will be asked to sign the CLA.
...
1. **Feature Development**:
    ...
    - Name the branch descriptively (e.g., `env/project name/env type`).
...
1. **Branch Naming**:
    ...
    - Use meaningful names for branches (e.g., `env/project name/env type`).
