...
BESMAN_ARTIFACT_NAME: cs-suite

# Version of the artifact under assessment.
BESMAN_ARTIFACT_VERSION: v2.0.0

# Source code url of the artifact under assessment.
BESMAN_ARTIFACT_URL: https://github.com/cloud-security-suite/cs-suite

# This variable stores the name of the environment file.
BESMAN_ENV_NAME: cs-suite-env
...
BESMAN_ARTIFACT_DIR: $HOME/cs-suite
...
# Name of the lab. Default is Cloud Security Suite. This variable indicates the individual's lab affiliation
BESMAN_LAB_NAME: Cloud Security Suite

# This is the local dir where we store the assessment reports. Default is home.
BESMAN_ASSESSMENT_DATASTORE_DIR: $HOME/cs-suite-assessment-datastore

# The remote repo where we store the assessment reports.
BESMAN_ASSESSMENT_DATASTORE_URL: https://github.com/cloud-security-suite/cs-suite-assessment-datastore

# Add a comma seperated list of tools that needs to be installed to assess this project.
BESMAN_ASSESSMENT_TOOLS: criticality_score,sonarqube,spdx-sbom-generator,fossology,docker
