...
function __besman_install_fastjson-RT-env
{
    ...
    namespace=asa1997
    __besman_gh_auth "$namespace" || return 1
    playbook=$HOME/besman-trigger-fastjson-RT-roles.yml
    export BESMAN_ANSIBLE_ROLE_PATH=$HOME/tmp
    export BESMAN_ANSIBLE_GALAXY_ROLES=asa1997/ansible-role-oah-java:asa1997/ansible-role-oah-maven:asa1997/ansible-role-oah-eclipse:asa1997/ansible-role-oah-docker:asa1997/ansible-role-oah-sonarQube:asa1997/ansible-role-oah-sbomGenerator
